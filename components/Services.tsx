...
export default function Services() {
  return (
    <section id="services-overview" className="py-24 md:py-28" aria-labelledby="services-heading">
      <Container>
            ...
            return (
              <motion.div key={service.title} variants={itemVariants}>
                <Card className="group h-full">
                  <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-xl border border-white/20 bg-white/5 text-accent-start transition-colors duration-300 group-hover:border-accent-start/45 group-hover:bg-accent-start/10">
